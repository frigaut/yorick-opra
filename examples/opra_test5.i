...
imcube = [];
grow,imcube,fits_read("opra_test5.foc0.fits")(,,,-);
grow,imcube,fits_read("opra_test5.focp0.4.fits")(,,,-);
grow,imcube,fits_read("opra_test5.focm0.4.fits")(,,,-);
...
opp = opra(imcube,allfocs,lambda,pixsize,7.9,nmodes=nmodesmax,use_mode=modes,\
  ...
  niter=10,fix_defoc=0,dpi=140,yao_parfile=parfile,gui=1);
